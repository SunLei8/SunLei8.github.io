...
<head>
<style>
  .bootstrap-iso {width:800px; border: 1px solid; text-align: justify; position:relative; left: 10px}
  .container {width:800px; border: 1px solid}
  .nav-tabs {width:800px; border: 1px solid}
  .tab-content {width:800px;border: 1px solid}
</style>
</head>
...
<br>
<br>
  <div style="width:1000px;text-align:justify; margin-left: 100px">
