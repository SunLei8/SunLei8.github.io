...
<head>
<style>
  .bootstrap-iso {width:750px; text-align: justify; border: 1px solid #000; position: absolute; left: 10px}
  .container {width:750px; border: 1px solid #111}
  .nav-tabs {width:720px; border: 1px solid #222}
  .tab-content {width:700px; border: 1px solid #050}
</style>
</head>
